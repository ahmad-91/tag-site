...
export default function UniqueFeatures() {
  ...
  const uniqueFeatures = [
    {
      ...
      icon: (
        <div className="relative group">
          ...
          <div className="relative w-20 h-20 bg-white rounded-2xl shadow-xl flex items-center justify-center transform group-hover:scale-110 transition-all duration-500">
            <svg className="w-12 h-12 text-accent-green" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* 15% Badge */}
            <div className="absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-br from-accent-green to-accent-green-dark rounded-full flex items-center justify-center shadow-xl border-2 border-white">
              <span className="text-sm font-black text-white">15%</span>
            </div>
          </div>
          {/* Green Top Bar */}
          <div className="absolute -top-1 left-2 right-2 h-1.5 bg-gradient-to-r from-accent-green to-accent-green-dark rounded-full"></div>
        </div>
      ),
      ...
      icon: (
        <div className="relative group">
          ...
          <div className="relative w-20 h-20 bg-white rounded-2xl shadow-xl flex items-center justify-center transform group-hover:scale-110 transition-all duration-500">
            ...
            {/* 30% Badge */}
            <div className="absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-br from-accent-purple to-accent-purple rounded-full flex items-center justify-center shadow-xl border-2 border-white">
              <span className="text-sm font-black text-white">30%</span>
            </div>
          </div>
          {/* Purple Top Bar */}
          <div className="absolute -top-1 left-2 right-2 h-1.5 bg-accent-purple rounded-full"></div>
        </div>
      ),
    ...
    },
    {
      ...
      icon: (
        <div className="relative group">
          ...
          <div className="relative w-20 h-20 bg-white rounded-2xl shadow-xl flex items-center justify-center transform group-hover:scale-110 transition-all duration-500">
            <svg className="w-12 h-12 text-accent-lime" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v2a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
            {/* 35% Badge */}
            <div className="absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-br from-accent-green to-accent-lime rounded-full flex items-center justify-center shadow-xl border-2 border-white">
              <span className="text-sm font-black text-white">35%</span>
            </div>
          </div>
          {/* Gradient Top Bar */}
          <div className="absolute -top-1 left-2 right-2 h-1.5 bg-gradient-to-r from-accent-green via-accent-lime to-accent-lime rounded-full"></div>
        </div>
      ),
      ...
      icon: (
        <div className="relative group">
          ...
          <div className="relative w-20 h-20 bg-gradient-to-br from-accent-purple to-accent-purple rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
            ...
            {/* QR Code overlay */}
            <div className="absolute -bottom-2 -left-2 w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-lg border-2 border-accent-purple/20">
  ...
  return (
    <section ref={sectionRef} className="relative py-24 bg-gradient-to-b from-white via-background-alt to-white overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="text-center mb-20">
          ...
          <div className="scroll-reveal inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-accent-green/10 via-accent-purple/10 to-accent-lime/10 border border-accent-green/20 mb-6">
            ...
            <span className="text-sm font-semibold text-text-primary tracking-wide">باقات مميزة</span>
          </div>

          {/* Title */}
          <h2 className="scroll-reveal text-4xl md:text-5xl lg:text-6xl font-arabic font-black mb-6 leading-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-l from-accent-green via-accent-purple to-accent-lime">الجيل الجديد</span> من الخصومات
          </h2>
          ...
          <p className="scroll-reveal text-lg md:text-xl text-text-secondary leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="font-semibold text-text-primary"> ليُطبّق الخصم مباشرة</span> دون أكواد أو قسائم.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-2xl -z-10" 
                     style={{background: `radial-gradient(circle at center, ${feature.iconColor.replace('text-', 'var(--color-')}20, transparent)`}}></div>
                
                {/* Card */}
                <div className={`relative ${feature.bgColor} rounded-[32px] p-10 border-2 ${feature.borderColor} transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl backdrop-blur-sm h-full flex flex-col min-h-[380px]`}>
                  {/* Icon */}
                  ...
                  {/* Subtitle */}
                  <p className={`text-base font-semiBold mb-4 ${feature.textColor} opacity-90 flex-shrink-0`}>
                    {feature.subtitle}
                  </p>
                  
                  {/* Title */}
                  <h3 className={`text-3xl md:text-4xl font-arabic font-black ${feature.textColor} flex-grow leading-tight`}>
                    {feature.title}
                  </h3>
